define.oldSkin({
    name: 'wysiwyg.viewer.skins.dropmenu.TextSeparatorsMenuNSkin',
    Class: {
        Extends:'mobile.core.skins.BaseSkin',
        compParts: {
            'repeaterButton':{ skin:'wysiwyg.viewer.skins.dropmenubutton.TextSeparatorsMenuButtonNSkin', styleGroup:'inherit' },
            'moreButton':{ skin:'wysiwyg.viewer.skins.dropmenubutton.TextSeparatorsMenuButtonNSkin', styleGroup:'inherit' }
        },
        _params: [
        ...
        _html: '<div skinPart="itemsContainer"></div><div skinPart="moreButton"></div><div skinPart="dropWrapper"><div skinPart="moreContainer"></div></div>',
        _css: [
